             ...
             toWebView:(UIWebView *)webView
{
    if(userInfo)
    {
        ...
        [webView stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"jsBridge.trigger('%@',%@)",name,json]];
    }
    else 
    {
...

{
    ...
    NSData* aData = [responseString dataUsingEncoding: NSASCIIStringEncoding];
